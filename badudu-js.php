...
function badudu_js_script() {
    ...
    wp_register_script( 'badudu-js', get_bloginfo('wpurl').'/wp-content/plugins/badudu-js' . '/badudu.min.js', array(),'version 1.0',true  );
    wp_enqueue_script( 'badudu-js' );

}
function badudu_css_script(){

    wp_register_style( 'badudujs-css', get_bloginfo('wpurl').'/wp-content/plugins/badudu-js' . '/badudujs.css',array(),'', 'screen' );
